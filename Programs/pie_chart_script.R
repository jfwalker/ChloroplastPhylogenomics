...
pep_nosupport<-read.csv("pep_nosupport.csv")
pep_support<-read.csv("pep_support.csv")

nuc_nosupport<-read.csv("nuc_nosupport.csv")
nuc_support<-read.csv("nuc_support.csv")

codon_nosupport<-read.csv("codon_nosupport.csv")
codon_support<-read.csv("codon_support.csv")
